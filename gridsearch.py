...
def main():
    ...
    parameter_grid_cpd = {'de':[300],'dr':[50],'dt':[50],'cuda':[cud],"input_dropout":[0.],"hidden_dropout1":[0.],"hidden_dropout2":[0.]}
    learning_param_grid = {'learning_rate':[0.005],'n_iter':[100],'batch_size':[128],'device':[DEVICE]}
    ##############################
